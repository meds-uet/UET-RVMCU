...
localparam int unsigned GPIO_INT_IDX    = 16;
/*localparam int unsigned UART_INT_IDX    = 17;
localparam int unsigned SPI_INT_IDX     = 18;*/
...
localparam logic [`XLEN-1:0] MIE_MASK = MIE_MSIP | MIE_MTIP | MIE_MEIP | MIE_GPIO; //| MIE_UART | MIE_SPI 
...
typedef enum logic [IRQ_CODE_WIDTH-1:0] {
    ...
    IRQ_CODE_GPIO       = 5'd16     // External GPIO interrupt
   /* IRQ_CODE_UART       = 5'd17,    // External UART interrupt
    IRQ_CODE_SPI        = 5'd18    // External SPI interrupt*/
} type_irq_code_e;
...
typedef struct packed {
    logic [13:0]                warl7;   // write any read legal value [11:0] spi, uart
    logic                       gpio_ie;
    /*logic                       spi_ie;
    logic                       uart_ie;*/
    logic [3:0]                 warl6;
