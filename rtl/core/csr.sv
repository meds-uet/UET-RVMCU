...
assign m_irq_req = meip_irq_req | mtip_irq_req | msip_irq_req | gpio_irq_req;
                  /*| uart_irq_req | spi_irq_req*/ 
assign irq_req   = exe2csr_ctrl.irq_req | gpio_irq_req;  //  | uart_irq_req | spi_irq_req
